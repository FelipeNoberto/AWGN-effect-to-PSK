...
class PSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "PSK and AWGN ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PSK and AWGN ")
        ...
        self._AWGN_range = qtgui.Range(0, 1, 0.25, 0.0, 200)
        self._AWGN_win = qtgui.RangeWidget(self._AWGN_range, self.set_AWGN, "AWGN LVL", "eng_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._AWGN_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, AWGN, 0)
    ...
    def set_AWGN(self, AWGN):
        self.AWGN = AWGN
        self.analog_noise_source_x_0.set_amplitude(self.AWGN)
